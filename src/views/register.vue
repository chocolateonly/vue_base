    ...
    <div class="login">
        <div class="login_main">
            ...
            <div class="login_main_right">
                <div class="login_title">智慧校园注册入口</div>
...
import { getVerifyApi, regVerifyApi } from "@/api/index";
...
export default {
    ...
    methods: {
        ...
        async loginBtn() {
            ...
            // this.btnLoading = true;
            // this.loginBtnTit = "正在注册...";
            // const res = 
            await this.axios.post(regVerifyApi, postdata)
                .then(res => {
                    // console.log(res);
                    if (res.data.code == 1) {
                        // this.btnLoading = false;
